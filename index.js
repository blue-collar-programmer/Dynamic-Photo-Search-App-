...
let ranURL = 'https://api.unsplash.com/photos/random?query=background&orientation=portrait&content_filter=high&client_id=BMOohXS2YcYfJKQkYYADqtZkkSWVQGpgRZ3qfiK_9Tk'//APIGOESHERE
...
form.addEventListener('submit', (e) => {
    ...
    let url = `https://api.unsplash.com/search/photos?query=${searchTopic}&per_page=21&client_id=BMOohXS2YcYfJKQkYYADqtZkkSWVQGpgRZ3qfiK_9Tk`;//APIKEYGOESHERE
